...
#### 1. Các packages cần dùng: axios, redux, react-query, react-router-dom

- API: Axios
- Store: Redux / React-query
- Router: React-router-dom (v6) - Docs: https://reactrouter.com/en/main/start/tutorial

#### 2. Yêu cầu chính (Thời gian 40 ~ 50 phút)

- Sử dụng redux, react-query để lưu store tất cả dữ liệu posts lấy về từ API
